...
int32_t parse_procfs_proc_pid_net_ipv4_file_impl(const int fd,
...
int32_t parse_procfs_proc_pid_net_ipv4_file(const char *filename,
                                            const int l4proto,
                                            scap_fdinfo **sockets,
                                            char *const error) {
	const int fd = open(filename, O_RDONLY, 0);
...
int32_t parse_procfs_proc_pid_net_ipv6_file_impl(const int fd,
                                                 const char *const filename,
                                                 scap_fdinfo **sockets,
                                                 const int l4proto,
                                                 char *const error) {
...
int32_t parse_procfs_proc_pid_net_ipv6_file(const char *filename,
                                            const int l4proto,
                                            scap_fdinfo **sockets,
                                            char *const error) {
	const int fd = open(filename, O_RDONLY, 0);
