...
/*
 * When adding a new event, a new line should be added with the list of ppm_sc codes mapping that
 * event. Events that are not mapped to any ppm_sc (ie: "container", "useradded"..., have NULL
 * entries.
 *
...
static const ppm_sc_code *g_events_to_sc_map[] = {
        [PPME_GENERIC_E] = (ppm_sc_code[]){PPM_SC_RESTART_SYSCALL,
                                           ...
                                           PPM_SC_GETSID,
                                           PPM_SC_FDATASYNC,
                                           PPM_SC_SCHED_SETSCHEDULER,
                                           PPM_SC_SCHED_GETSCHEDULER,
                                           PPM_SC_SCHED_YIELD,
                                           PPM_SC_SCHED_GET_PRIORITY_MAX,
                                           PPM_SC_SCHED_GET_PRIORITY_MIN,
                                           PPM_SC_SCHED_RR_GET_INTERVAL,
                                           PPM_SC_MREMAP,
                                           PPM_SC_ARCH_PRCTL,
                                           PPM_SC_RT_SIGACTION,
                                           PPM_SC_RT_SIGPROCMASK,
                                           PPM_SC_RT_SIGPENDING,
                                           PPM_SC_RT_SIGTIMEDWAIT,
                                           PPM_SC_RT_SIGQUEUEINFO,
                                           PPM_SC_RT_SIGSUSPEND,
                                           PPM_SC_CAPGET,
                                           PPM_SC_GETGROUPS,
                                           PPM_SC_SETGROUPS,
                                           PPM_SC_SETFSUID,
                                           ...
                                           PPM_SC_LREMOVEXATTR,
                                           PPM_SC_FREMOVEXATTR,
                                           PPM_SC_SCHED_SETAFFINITY,
                                           PPM_SC_SCHED_GETAFFINITY,
                                           PPM_SC_SET_THREAD_AREA,
                                           PPM_SC_GET_THREAD_AREA,
                                           PPM_SC_IO_SETUP,
                                           PPM_SC_IO_DESTROY,
                                           PPM_SC_IO_GETEVENTS,
                                           PPM_SC_IO_SUBMIT,
                                           PPM_SC_IO_CANCEL,
                                           PPM_SC_EXIT_GROUP,
                                           PPM_SC_REMAP_FILE_PAGES,
                                           PPM_SC_SET_TID_ADDRESS,
                                           PPM_SC_TIMER_CREATE,
                                           PPM_SC_TIMER_SETTIME,
                                           PPM_SC_TIMER_GETTIME,
                                           PPM_SC_TIMER_GETOVERRUN,
                                           PPM_SC_TIMER_DELETE,
                                           PPM_SC_CLOCK_SETTIME,
                                           PPM_SC_CLOCK_GETTIME,
                                           PPM_SC_CLOCK_GETRES,
                                           PPM_SC_CLOCK_NANOSLEEP,
                                           PPM_SC_UTIMES,
                                           PPM_SC_MQ_OPEN,
                                           PPM_SC_MQ_UNLINK,
                                           PPM_SC_MQ_TIMEDSEND,
                                           ...
                                           PPM_SC_INOTIFY_RM_WATCH,
                                           PPM_SC_FUTIMESAT,
                                           PPM_SC_READLINKAT,
                                           PPM_SC_FACCESSAT,
                                           PPM_SC_SET_ROBUST_LIST,
                                           ...
                                           PPM_SC_EPOLL_PWAIT,
                                           PPM_SC_UTIMENSAT,
                                           PPM_SC_TIMERFD_SETTIME,
                                           PPM_SC_TIMERFD_GETTIME,
                                           PPM_SC_RT_TGSIGQUEUEINFO,
                                           PPM_SC_PERF_EVENT_OPEN,
                                           ...
                                           PPM_SC_OPEN_TREE,
                                           PPM_SC_MOVE_MOUNT,
                                           PPM_SC_MOUNT_SETATTR,
                                           PPM_SC_MEMFD_SECRET,
                                           PPM_SC_IOPERM,
                                           PPM_SC_KEXEC_FILE_LOAD,
                                           PPM_SC_PIDFD_SEND_SIGNAL,
                                           PPM_SC_PKEY_ALLOC,
                                           PPM_SC_PKEY_MPROTECT,
                                           PPM_SC_PKEY_FREE,
                                           PPM_SC_LANDLOCK_CREATE_RULESET,
                                           PPM_SC_QUOTACTL_FD,
                                           PPM_SC_LANDLOCK_RESTRICT_SELF,
                                           PPM_SC_LANDLOCK_ADD_RULE,
                                           PPM_SC_EPOLL_PWAIT2,
                                           PPM_SC_MIGRATE_PAGES,
                                           PPM_SC_MOVE_PAGES,
                                           PPM_SC_PREADV2,
                                           PPM_SC_PWRITEV2,
                                           PPM_SC_QUERY_MODULE,
                                           PPM_SC_STATX,
                                           PPM_SC_SET_MEMPOLICY,
                                           PPM_SC_FANOTIFY_MARK,
                                           PPM_SC_SYNC_FILE_RANGE,
                                           PPM_SC_READAHEAD,
                                           PPM_SC_PROCESS_MRELEASE,
                                           PPM_SC_MBIND,
                                           PPM_SC_PROCESS_MADVISE,
                                           PPM_SC_MEMBARRIER,
                                           PPM_SC_MODIFY_LDT,
                                           PPM_SC_SEMTIMEDOP,
                                           PPM_SC_NAME_TO_HANDLE_AT,
                                           PPM_SC_KCMP,
                                           PPM_SC_EPOLL_CTL_OLD,
                                           PPM_SC_EPOLL_WAIT_OLD,
                                           PPM_SC_FUTEX_WAITV,
                                           PPM_SC_CREATE_MODULE,
                                           PPM_SC__SYSCTL,
                                           PPM_SC_LOOKUP_DCOOKIE,
                                           PPM_SC_IOPL,
                                           PPM_SC_IO_PGETEVENTS,
                                           PPM_SC_GETPMSG,
                                           ...
                                           PPM_SC_NFSSERVCTL,
                                           PPM_SC_SET_MEMPOLICY_HOME_NODE,
                                           PPM_SC_FACCESSAT2,
                                           PPM_SC_EPOLL_CTL,
                                           PPM_SC_SCHED_GETPARAM,
                                           PPM_SC_PSELECT6,
        ...
        [PPME_SYSCALL_LSTAT64_E] =
                (ppm_sc_code[]){PPM_SC_LSTAT64, -1},  // lstat64 -> is not impl by supported archs
        ...
        [PPME_SYSCALL_SETREUID_E] = (ppm_sc_code[]){PPM_SC_SETREUID, -1},
        ...
        [PPME_ITER_TASK_FILE_SOCKET_INET_E] = NULL,
        [PPME_ITER_TASK_FILE_SOCKET_INET_X] = NULL,
        [PPME_ITER_TASK_FILE_SOCKET_INET6_E] = NULL,
        [PPME_ITER_TASK_FILE_SOCKET_INET6_X] = NULL,
        [PPME_ITER_TASK_FILE_SOCKET_UNIX_E] = NULL,
        [PPME_ITER_TASK_FILE_SOCKET_UNIX_X] = NULL,
        [PPME_ITER_TASK_FILE_SOCKET_NETLINK_E] = NULL,
        [PPME_ITER_TASK_FILE_SOCKET_NETLINK_X] = NULL,
        [PPME_ITER_TASK_FILE_PIPE_E] = NULL,
        [PPME_ITER_TASK_FILE_PIPE_X] = NULL,
        [PPME_ITER_TASK_FILE_DIRECTORY_E] = NULL,
        [PPME_ITER_TASK_FILE_DIRECTORY_X] = NULL,
        [PPME_ITER_TASK_FILE_REGULAR_E] = NULL,
        [PPME_ITER_TASK_FILE_REGULAR_X] = NULL,
        [PPME_ITER_TASK_FILE_ANON_INODE_E] = NULL,
        [PPME_ITER_TASK_FILE_ANON_INODE_X] = NULL,
        [PPME_ITER_TASK_FILE_MEMFD_E] = NULL,
        [PPME_ITER_TASK_FILE_MEMFD_X] = NULL,
};

#if defined(__GNUC__) || (__STDC_VERSION__ >= 201112L)
_Static_assert(sizeof(g_events_to_sc_map) / sizeof(*g_events_to_sc_map) == PPM_EVENT_MAX,
               "Missing entries in g_events_to_sc_map table.");
#endif
