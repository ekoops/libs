...
static void pman_save_attached_progs() {
	...
	g_state.attached_progs_fds[9] = bpf_program__fd(g_state.skel->progs.connect_e);
	g_state.attached_progs_fds[10] = bpf_program__fd(g_state.skel->progs.creat_e);
	g_state.attached_progs_fds[11] = bpf_program__fd(g_state.skel->progs.open_e);
