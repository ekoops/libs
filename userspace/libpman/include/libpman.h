 ...
 * @return `0` on success, `errno` in case of error.
 */
int pman_attach_creat_toctou_mitigation_progs(void);
 ...
 * @return `0` on success, `errno` in case of error.
 */
int pman_attach_openat_toctou_mitigation_progs(void);
 ...
 * @return `0` on success, `errno` in case of error.
 */
int pman_detach_openat_toctou_mitigation_progs(void);
...
int pman_iter_get_tasks(int tid_filter, void* error);
int pman_iter_get_task_files(int pid_filter, int fd_filter, void* error);
