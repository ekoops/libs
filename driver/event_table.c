...
const struct ppm_event_info g_event_info[] = {
        ...
        [PPME_SYSCALL_FSTAT64_E] =
                {"fstat64", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"fd", PT_FD, PF_NA}}},
        ...
        [PPME_SYSCALL_PREADV_X] = {"preadv",
                                   ...
                                   {{"res", PT_ERRNO, PF_DEC},
                                    ...
                                    {"fd", PT_FD, PF_DEC},
                                    {"pos", PT_UINT64, PF_DEC}}},
        [PPME_SYSCALL_PWRITEV_E] = {"pwritev",
                                    EC_IO_WRITE | EC_SYSCALL,
                                    EF_USES_FD | EF_WRITES_TO_FD | EF_TMP_CONVERTER_MANAGED,
                                    3,
                                    {{"fd", PT_FD, PF_DEC},
        ...
        [PPME_SCHEDSWITCH_1_E] = {"switch",
                                  ...
                                  EF_SKIPPARSERESET | EF_OLD_VERSION,
                                  1,
                                  {{"next", PT_PID, PF_DEC}}},
        [PPME_SCHEDSWITCH_1_X] = {"NA",
                                  EC_UNKNOWN,
                                  EF_SKIPPARSERESET | EF_UNUSED | EF_OLD_VERSION,
                                  0},
        [PPME_DROP_E] = {"drop",
        ...
        [PPME_CONTAINER_E] = {"container",
                              EC_INTERNAL | EC_METAEVENT,
                              EF_SKIPPARSERESET | EF_MODIFIES_STATE | EF_OLD_VERSION,
                              4,
                              {{"id", PT_CHARBUF, PF_NA},
                               {"type", PT_UINT32, PF_DEC},
                               {"name", PT_CHARBUF, PF_NA},
        ...
        [PPME_SYSCALL_BPF_2_E] =
                {"bpf", EC_OTHER | EC_SYSCALL, EF_CREATES_FD, 1, {{"cmd", PT_INT64, PF_DEC}}},
