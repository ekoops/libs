...
const struct ppm_event_info g_event_info[] = {
        ...
        [PPME_SYSCALL_SETREGID_X] = {"setregid",
                                     ...
                                     {{"res", PT_ERRNO, PF_DEC},
                                      {"rgid", PT_UID, PF_DEC},
                                      {"egid", PT_UID, PF_DEC}}},
        [PPME_ITER_TASK_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_X] = {"task",
                              EC_PROCESS | EC_ITER,
                              EF_MODIFIES_STATE,
                              30,
                              {{"tgid", PT_PID, PF_DEC},
                               ...
                               {"tty", PT_UINT32, PF_DEC},
                               {"loginuid", PT_UID, PF_DEC}}},
        [PPME_ITER_TASK_FILE_SOCKET_INET_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_SOCKET_INET_X] = {"task_file_socket_inet",
                                               EC_PROCESS | EC_ITER,
                                               EF_MODIFIES_STATE,
                                               8,
                                               {{"fd", PT_FD, PF_DEC},
                                                ...
                                                {"local_ip", PT_UINT32, PF_DEC},
                                                {"local_port", PT_UINT16, PF_DEC},
                                                {"remote_ip", PT_UINT32, PF_DEC},
                                                {"remote_port", PT_UINT16, PF_DEC},
                                                {"ino_num", PT_UINT64, PF_DEC}}},
        [PPME_ITER_TASK_FILE_SOCKET_INET6_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_SOCKET_INET6_X] = {"task_file_socket_inet6",
                                                EC_PROCESS | EC_ITER,
                                                EF_MODIFIES_STATE,
                                                10,
                                                {{"fd", PT_FD, PF_DEC},
                                                 {"sk_type", PT_UINT16, PF_DEC},
                                                 {"sk_proto", PT_UINT16, PF_DEC},
                                                 {"local_ip_high", PT_UINT64, PF_DEC},
                                                 {"local_ip_low", PT_UINT64, PF_DEC},
                                                 {"local_port", PT_UINT16, PF_DEC},
                                                 {"remote_ip_high", PT_UINT64, PF_DEC},
                                                 {"remote_ip_low", PT_UINT64, PF_DEC},
                                                 {"remote_port", PT_UINT16, PF_DEC},
                                                 {"ino_num", PT_UINT64, PF_DEC}}},
        [PPME_ITER_TASK_FILE_SOCKET_UNIX_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_SOCKET_UNIX_X] = {"task_file_socket_unix",
                                               EC_PROCESS | EC_ITER,
                                               EF_MODIFIES_STATE,
                                               5,
                                               {{"fd", PT_FD, PF_DEC},
                                                {"sk_type", PT_UINT16, PF_DEC},
                                                {"sk_proto", PT_UINT16, PF_DEC},
                                                {"sun_path", PT_CHARBUF, PF_NA},
                                                {"ino_num", PT_UINT64, PF_DEC}}},
        [PPME_ITER_TASK_FILE_PIPE_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_PIPE_X] = {"task_file_pipe",
                                        EC_PROCESS | EC_ITER,
                                        EF_MODIFIES_STATE,
                                        3,
                                        {{"fd", PT_FD, PF_DEC},
                                         {"name", PT_FSPATH, PF_NA},
                                         {"ino_num", PT_UINT64, PF_DEC}}},
        [PPME_ITER_TASK_FILE_DIRECTORY_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_DIRECTORY_X] = {"task_file_directory",
                                             EC_PROCESS | EC_ITER,
                                             EF_MODIFIES_STATE,
                                             3,
                                             {{"fd", PT_FD, PF_DEC},
                                              {"name", PT_FSPATH, PF_NA},
                                              {"ino_num", PT_UINT64, PF_DEC}}},
        [PPME_ITER_TASK_FILE_REGULAR_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_REGULAR_X] = {"task_file_regular",
                                           EC_PROCESS | EC_ITER,
                                           EF_MODIFIES_STATE,
                                           5,
                                           {{"fd", PT_FD, PF_DEC},
                                            ...
                                            {"ino_num", PT_UINT64, PF_DEC}}},
        [PPME_ITER_TASK_FILE_ANON_INODE_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_ANON_INODE_X] =
                {"task_file_anon_inode",
                 ...
                 4,
                 {{"fd", PT_FD, PF_DEC},
                  {"fd_type", PT_FLAGS32, PF_HEX, file_flags},
                  {"name",
                   PT_FSPATH,
                   PF_NA},  // filled only if fd_type == ANON_INODE_FD_TYPE_UNKNOWN
                  {"ino_num", PT_UINT64, PF_DEC}}},
        [PPME_ITER_TASK_FILE_MEMFD_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_MEMFD_X] = {"task_file_memfd",
                                         EC_PROCESS | EC_ITER,
                                         EF_MODIFIES_STATE,
                                         3,
                                         {{"fd", PT_FD, PF_DEC},
