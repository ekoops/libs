        ...
        [PPME_ITER_TASK_FILE_SOCKET_UNIX_X] =
                {"task_file_socket_unix",
                 ...
                 {{"fd", PT_FD, PF_DEC},
                  {"sk_type", PT_UINT16, PF_DEC},
                  {"sk_proto", PT_UINT16, PF_DEC},
                  {"sk_pointer", PT_UINT64, PF_NA},  // TODO: check why some paths are empty
                  {"sun_path", PT_FSPATH, PF_NA},    // TODO: check why some paths are empty
                  {"ino_num", PT_UINT64, PF_DEC}}},
        [PPME_ITER_TASK_FILE_SOCKET_NETLINK_E] = {"NA", EC_UNKNOWN, EF_UNUSED, 0},
        [PPME_ITER_TASK_FILE_SOCKET_NETLINK_X] = {"task_file_socket_netlink",
                                                  EC_PROCESS | EC_ITER,
                                                  EF_MODIFIES_STATE,
                                                  4,
                                                  {{"fd", PT_FD, PF_DEC},
