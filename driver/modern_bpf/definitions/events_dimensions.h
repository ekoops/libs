...
#define TASK_FILE_SOCKET_INET_X_SIZE HEADER_LEN + sizeof(int64_t) + sizeof(uint16_t) * 4 + sizeof(uint32_t) * 2 + sizeof(uint64_t) + PARAM_LEN * 8
#define TASK_FILE_SOCKET_INET6_X_SIZE HEADER_LEN + 16 * 2 + sizeof(int64_t) + sizeof(uint16_t) * 4 + sizeof(uint64_t) + PARAM_LEN * 8
#define TASK_FILE_SOCKET_NETLINK_X_SIZE HEADER_LEN + sizeof(int64_t) + sizeof(uint16_t) * 2 + sizeof(uint64_t) + PARAM_LEN * 4
