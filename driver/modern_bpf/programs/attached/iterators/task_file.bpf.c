...
int dump_task(struct bpf_iter__task *ctx) {
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_X);
	...
	// start_time
	uint64_t start_time = maps__get_boot_time() + task->start_boottime;
...
static __always_inline int dump_inet_socket(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_SOCKET_INET_X);
...
static __always_inline int dump_inet6_socket(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_SOCKET_INET6_X);
...
static __always_inline int dump_unix_socket(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_SOCKET_UNIX_X);
...
static __always_inline int dump_netlink_socket(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_SOCKET_NETLINK_X);
...
static int dump_pipe(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_PIPE_X);
...
static int dump_memfd_file(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_MEMFD_X);
...
static int dump_anon_inode_file(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_ANON_INODE_X);
...
static int dump_regular_or_device_file(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_REGULAR_X);
...
static int dump_directory(struct seq_file *seq,
	...
	auxmap_iter__preload_event_header(auxmap, tgid_pid, PPME_ITER_TASK_FILE_DIRECTORY_X);
