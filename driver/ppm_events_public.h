...
typedef enum {
	...
	PPME_ITER_TASK_FILE_PIPE_E = 438,
	PPME_ITER_TASK_FILE_PIPE_X = 439,
	PPME_ITER_TASK_FILE_DIRECTORY_E = 440,
	PPME_ITER_TASK_FILE_DIRECTORY_X = 441,
	PPME_ITER_TASK_FILE_REGULAR_E = 442,
	PPME_ITER_TASK_FILE_REGULAR_X = 443,
	PPME_ITER_TASK_FILE_ANON_INODE_E = 444,
	PPME_ITER_TASK_FILE_ANON_INODE_X = 445,
	PPME_ITER_TASK_FILE_MEMFD_E = 446,
	PPME_ITER_TASK_FILE_MEMFD_X = 447,
	PPM_EVENT_MAX = 448
} ppm_event_code;
/*@}*/
...
enum ppm_event_category {
	...
	EC_METAEVENT = (1 << 12),  /* Meta-event not generated by a source but used for notifications or
	                              enrichment */
	EC_ITER = (1 << 13),       /* Event generator by iterator */
};
...
enum anon_inode_fd_type {
	...
	ANON_INODE_FD_TYPE_PERF_EVENT = 12,
	ANON_INODE_FD_TYPE_DMABUF = 13,
};
